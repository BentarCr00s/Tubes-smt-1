...
{
    Mahasiswa mhs;
    // Menambahkan Nim setiap generasi
    mhs.NIM + 1;
    cout << "Masukkan nama mahasiswa: ";
    cin >> mhs.nama;
    cout << "Masukkan Tanggal lahir mahasiswa: ";
    cin >> mhs.tgl_lahir;
...
void lihatMahasiswa(vector<Mahasiswa> daftarMahasiswa)
{
    for (int i = 0; i < daftarMahasiswa.size(); i++)
    {
        cout << i + 1 << ". " << daftarMahasiswa[i].nama << " (" << daftarMahasiswa[i].jurusan << ", " << daftarMahasiswa[i].tgl_lahir << ")" << endl;
    }
}
...
void cariMahasiswa(vector<Mahasiswa> daftarMahasiswa)
{
    ...
    for (int i = 0; i < daftarMahasiswa.size(); i++)
    {
        if (daftarMahasiswa[i].nama == namaMhs)
        {
            cout << daftarMahasiswa[i].nama << " (" << daftarMahasiswa[i].jurusan << ", " << daftarMahasiswa[i].tgl_lahir << ")" << endl;
        }
    }
}
...
void simpanKeFile(vector<Mahasiswa> daftarMahasiswa, vector<Jurusan> daftarJurusan)
{
    ...
    for (int i = 0; i < daftarMahasiswa.size(); i++)
    {
        ...
        fileMahasiswa << daftarMahasiswa[i].tgl_lahir << endl;
    }
